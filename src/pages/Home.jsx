...
export default function Home() {
  ...
  const handleFileValidated = async (data, name) => {
    ...
    try {
      const response = await fetch('https://app-aitax-backend.onrender.com/api/analyze', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ rows: data, fileName: name })
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      {/* Header - solo en página de resultados */}
      {analysisComplete && (
          ...
          {!analysisComplete ? (
            ...
            >
              ...
              <div className="text-center max-w-2xl mx-auto">
                ...
                >
                  <h2 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight mb-4 mt-8">
